...
regressor.fit(X_train, y_train, epochs = 240, batch_size = 32)
#
#--------------------- Testing RNN model --------------------#
...
plt.plot(real_stock_price, color = '#ffd700', label = "rss")
plt.plot(predicted_stock_price, color = '#4782B4', label = "pss")
plt.title("direction")
plt.xlabel("days")
plt.ylabel("price")
